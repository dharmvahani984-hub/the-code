    ...
    while true; do
        ...
        case "$uopt" in
            1)
                ...
                cd /www/wwwroot/panel.obsidianhosting.in || { echo -e "${RED}Path not found!${RESET}"; sleep 2; continue; }
                blueprint -r nebula
...
while true; do
    ...
    case "$opt" in
        ...
        4)
            ...
            wget -q https://github.com/dharmvahani984-hub/the-code/raw/refs/heads/main/srv/thame/sagaminecraftplayermanager.blueprint
            wget -q https://github.com/dharmvahani984-hub/the-code/raw/refs/heads/main/srv/thame/huxregister.blueprint
